...
/** Xnuva unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** Xnuva display units. Internal enum names are retained for serialized GUI-setting compatibility. */
    enum class Unit {
        BTC,
        mBTC,
        uBTC,
    ...
    //! Number of Prince (1e-8 XNUV) per unit
    ...
    //! Return maximum number of base units (Prince)
