...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xnuva address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xnuva: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xnuva addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xnuva addresses"));
    ...
    openAction->setStatusTip(tr("Open a xnuva: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Xnuva network.", "", count);
    } else {
        //: A substring of the tooltip.
